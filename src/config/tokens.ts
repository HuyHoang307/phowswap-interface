...
export const MATIC: { [key: string]: Token } = {
  ...
  PHO: new Token(ChainId.MATIC, '0x0b3F868E0BE5597D5DB7fEB59E1CADBb0fdDa50a', 18, 'PHO', 'PhoToken'),
...
export const XPHO_CALL = new Token(
  ChainId.MAINNET,
  '0xada279f9301C01A4eF914127a6C2a493Ad733924',
  18,
  'XSUc25-0531',
  'XPHO 25 Call [31 May 2021]'
)
...
export const AXPHO = new Token(
  ChainId.MAINNET,
  '0xF256CC7847E919FAc9B808cC216cAc87CCF2f47a',
  18,
  'aXPHO',
  'Aave interest bearing XPHO'
)
