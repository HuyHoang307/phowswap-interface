...
import { ChainId, Currency, Token, WNATIVE } from 'phoswap-sdk'
...
export const CUSTOM_BASES: {
  ...
  [ChainId.MATIC]: {
    [MATIC.TEL.address]: [MATIC.PHO, MATIC.AAVE],
  },
}
...
export const COMMON_BASES: ChainTokenList = {
  [ChainId.MAINNET]: [...WRAPPED_NATIVE_ONLY[ChainId.MAINNET], DAI, USDC, USDT, WBTC, OHM, PHO[ChainId.MAINNET]],
  [ChainId.MATIC]: [
...
export const PINNED_PAIRS: {
  ...
  [ChainId.MAINNET]: [
    [PHO[ChainId.MAINNET], WNATIVE[ChainId.MAINNET]],
    [
