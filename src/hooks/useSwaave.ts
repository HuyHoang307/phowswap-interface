...
import { usePhoBarContract, usePhoContract } from './useContract'
...
const usePhoBar = () => {
  ...
  const sushiContract = usePhoContract(true) // withSigner
  const barContract = usePhoBarContract(true) // withSigner
