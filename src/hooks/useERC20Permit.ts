import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from 'phoswap-sdk'
import { DAI, PHO, USDC } from '../config/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [PHO[1].address]: { type: PermitType.AMOUNT, name: 'PhoSwap' },
  },
  [4]: {
    ...
    [PHO[4].address]: { type: PermitType.AMOUNT, name: 'PhoSwap' },
  }
}
