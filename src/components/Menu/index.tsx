...
const items = (i18n: I18n) => [
  {
    name: i18n._(t`Docs`),
    description: i18n._(t`Documentation for users of Pho.`),
    href: 'https://docs.sushi.com',
  },
  {
    name: i18n._(t`Dev`),
    description: i18n._(t`Documentation for developers of Pho.`),
    href: 'https://dev.sushi.com',
  },
  {
    name: i18n._(t`Open Source`),
    description: i18n._(t`Pho is a supporter of Open Source.`),
