import { ChainId, Currency, NATIVE, PHO_ADDRESS } from 'phoswap-sdk'
            ...
            <div className="px-4 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <Image src="/logo.png" alt="Pho" width="32px" height="32px" />
                            ...
                            onClick={() => {
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added PHO to MetaMask')
                                    } else {
