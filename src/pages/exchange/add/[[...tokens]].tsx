...
import { Currency, CurrencyAmount, Percent, WNATIVE, currencyEquals } from 'phoswap-sdk'
...
export default function Add() {
  ...
  return (
    <>
      <Head>
        <title>Add Liquidity | Pho</title>
        <meta
          key="description"
          name="description"
          content="Add liquidity to the PhoSwap AMM to enable gas optimised and low slippage trades across countless networks"
        />
      </Head>
