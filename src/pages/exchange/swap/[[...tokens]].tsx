import { ChainId, Currency, CurrencyAmount, JSBI, Token, TradeType, Trade as V2Trade } from 'phoswap-sdk'
...
export default function Swap() {
  ...
  return (
    <Container id="swap-page" className="py-4 md:py-8 lg:py-12">
      <Head>
        <title>Swap | Pho</title>
        <meta
          key="description"
          name="description"
          content="PhoSwap allows for swapping of ERC20 compatible tokens across multiple networks"
        />
      </Head>
      <TokenWarningModal
