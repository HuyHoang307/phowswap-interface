...
export function usePhoPrice(variables = undefined, swrConfig: SWRConfiguration = undefined) {
  const { data } = useSWR(['sushiPrice', stringify(variables)], () => getPhoPrice(variables), swrConfig)
  return data
}
