import { CHAINLINK_ORACLE_ADDRESS, ChainId, Token } from 'phoswap-sdk'
...
export class PhoSwapTWAP0Oracle extends AbstractOracle {
...
export class PhoSwapTWAP1Oracle extends AbstractOracle {
  constructor(pair, chainId: ChainId, tokens?: Token[]) {
    super(pair, chainId, tokens)
    this.name = 'PhoSwap'
  }
