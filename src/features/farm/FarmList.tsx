...
export const TOKEN_PHO_PER_BLOCK: { [chainId in ChainId]?: number } = {
  [ChainId.MAINNET]: 100,
  [ChainId.RINKEBY]: 100,
...
const FarmList = ({ farms, currentFarmType, changeFarmType, chainId }) => {
        ...
        <GroupItemFarm>
          {farms.map((farm) => {
            ...
            if (farm.endDate === 0 && farm.type === currentFarmType) {
              ...
              return <FarmListItem farm={farm} farmLength={farms.length} />
            } else {
              return ''
            }
          })}
