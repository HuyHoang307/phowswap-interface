...
import { phoardData } from './deposit'
    ...
    <Modal isOpen={isOpenWithDraw} onDismiss={onDismissWithDraw} className="w-full">
      <WithDrawBlock>
        ...
        <div className="flex justify-between mb-3 w-full">
          ...
          <TitleBalance onClick={() => setFirstValue(phoardData(userStake))}>
            {`${
            ...
            <StyledNewTooltip>
              <NewTooltip
                dataTip={phoardData(userStake)}
                dataValue={handleUserStakeValue(phoardData(userStake))}
              />
            </StyledNewTooltip>
          </TitleBalance>
        </div>
